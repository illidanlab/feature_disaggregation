...
b = Least_L21(xall,Ytrn,15);
% [b,gamma] = cv_solver_L21(Ytrn,Xtrn,Xlrtrn,20,0,Gestimate,50,1e-4);
%test two stage
...
set(gca,'YtickLabel',{'open','low','medium','high','deciduous','evergreen','mixed','pasture','crops','wooded','herbaceous','max depth','iws/lakearea'});
% set(gca,'XtickLabel',{'open','low','medium','high','deciduous','evergreen','mixed','pasture','crops','wooded','herbaceous','max depth','iws/lakearea'});
set(gca,'XtickLabel',{'area','base flow','dep totaln','runoff','developed','forest','algriculture','wetland'});